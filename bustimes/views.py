...
def maybe_download_file(local_path, s3_key):
    if not local_path.exists():
        ...
        client = boto3.client("s3", endpoint_url="https://af0f6a75593ef78088ace99b1b164934.eu.r2.cloudflarestorage.com")
        client.download_file(
            Bucket="tb-data", Key=s3_key, Filename=str(local_path)
        )
